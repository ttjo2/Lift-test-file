...
public class Lift extends Actor
{
    ...
    // This should be a list of person objects, instead of
    // just an integer
    private int people;
    ...
    private void goingUp()
    {
        ...
        if(floor != null) {
            openDoors();
            floor.liftArrived(Button.UP, this);
            people++;
            updateImage();
        }
    }
    ...
    private void goingDown()
    {
        ...
        if(floor != null) {
            openDoors();
            floor.liftArrived(Button.DOWN, this);
            people--;
            updateImage();
        }
    }
    ...
    private void standingClosed()
    {
        if(randomizer.nextInt(100) > 95) {
            Floor floor = atFloor();
            // the decision to go down or up should be based
            // on the button pressed on the floor
